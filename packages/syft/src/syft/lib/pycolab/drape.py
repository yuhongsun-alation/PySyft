...
from ...proto.lib.pycolab.drape_pb2 import Drape as Drape_PB


class DataDrape(things.Drape):
...
def object2proto(obj: things.Drape) -> Drape_PB:
    thing = Drape_PB()
    thing.obj_type = "pycolab.things.Drape"
...
def proto2object(proto: Drape_PB) -> things.Drape:
    thing = DataDrape()
...
GenerateWrapper(
    wrapped_type=things.Drape,
    import_path="pycolab.things.Drape",
    protobuf_scheme=Drape_PB,
