...
class CursesUi(object):
    ...
    def __init__(
        ...
        self._colour_fg = (
            ...
            if colour_fg is not None
            else {}
        )
        self._colour_bg = (
            {ord(char): colour for char, colour in six.iteritems(colour_bg)}
            if colour_bg is not None
            else self._colour_fg
        )
    ...
    def play(self, game):
        ...
        print(
            "Game over! Final score is {}, earned over {}.".format(
    ...
    def _display(self, screen, observations, score, elapsed):
        ...
        screen.addstr(0, 20, f"Score: {score}", curses.color_pair(0))
