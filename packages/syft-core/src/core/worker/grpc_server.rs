use crate::core::capabilities::helloworld::{GreeterServer, MyGreeter};
use crate::core::capabilities::message::{MessageServer, MyMessage};
use crate::core::capabilities::node::{ConfigServer, ConfigService};
use crate::core::worker::config::{get_config, get_runtime_handle, Callback, Configurable};
