use crate::core::capabilities::helloworld::{GreeterClient, HelloRequest};
use crate::core::capabilities::message::{DataMessage, MessageClient};
use crate::core::capabilities::node::{ConfigClient, ConnectRequest, NodeRequest};
